...
CC_COMP="--cc=gcc"
~/Local/Documents/Programs/julia-1.1.0/julia ~/.julia/packages/PackageCompiler/oT98U/juliac.jl -Re $MODULE_OPT $CODE_OPT $CC_COMP src/core/juliachem.jl src/core/juliachem.c
