...
"""
=#
function get_oei_matrix(oei::Array{T,2}) where {T<:Number}
    nbf::Int64 = 7
    nbf2::Int64 = nbf*(nbf+1)/2

    oei_matrix = Matrix{T}(undef,nbf,nbf)
...
"""
=#
function get_tei_matrix(tei::Array{T,2}) where {T<:Number}
    nint::Int64 = 228

    tei_array::Array{T,1} = Array{T}(undef,2401)
