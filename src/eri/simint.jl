...
@inline function initialize()
  ccall((:initialize_c, "/export/home/david/projects/Julia/JuliaChem.jl/src/eri/libjeri.so"), Cvoid, ())
end
export initialize

@inline function finalize()
  ccall((:finalize_c, "/export/home/david/projects/Julia/JuliaChem.jl/src/eri/libjeri.so"), Cvoid, ())
end
export finalize

@inline function reset()
  ccall((:reset_c, "/export/home/david/projects/Julia/JuliaChem.jl/src/eri/libjeri.so"), Cvoid, ())
end
export reset

@inline function get_julia_shell_info(shell::JCModules.BasisStructs.Shell)
  ccall( (:get_julia_shell_info_c, "/export/home/david/projects/Julia/JuliaChem.jl/src/eri/libjeri.so"), Cvoid,
    (Ref{JCModules.BasisStructs.Shell},), Ref(shell) )
end
export get_julia_shell_info

@inline function get_simint_shell_info(shell::Int64)
  ccall( (:get_simint_shell_info_c, "/export/home/david/projects/Julia/JuliaChem.jl/src/eri/libjeri.so"), Cvoid,
    (Int64,), shell )
end
...
@inline function allocate_shell_array(basis::JCModules.BasisStructs.Basis)
  ...
  ccall( (:allocate_shell_array_c, "/export/home/david/projects/Julia/JuliaChem.jl/src/eri/libjeri.so"), Cvoid,
...
@inline function add_shell(shell::JCModules.BasisStructs.Shell)
  ccall( (:add_shell_c, "/export/home/david/projects/Julia/JuliaChem.jl/src/eri/libjeri.so"), Cvoid,
    (Ref{JCModules.BasisStructs.Shell},), Ref(shell) )
end
export add_shell

@inline function normalize_shells()
  ccall( (:normalize_shells_c, "/export/home/david/projects/Julia/JuliaChem.jl/src/eri/libjeri.so"), Cvoid,
    () )
end
...
@inline function create_ij_shell_pair(ish::Int64, jsh::Int64)
  ccall( (:create_ij_shell_pair_c, "/export/home/david/projects/Julia/JuliaChem.jl/src/eri/libjeri.so"),
    Cvoid, (Int64, Int64), ish, jsh)
end
export create_ij_shell_pair

@inline function allocate_kl_shell_pair(ksh::Int64, lsh::Int64)
  ccall( (:allocate_kl_shell_pair_c, "/export/home/david/projects/Julia/JuliaChem.jl/src/eri/libjeri.so"),
    Cvoid, (Int64, Int64), ksh, lsh)
end
export allocate_kl_shell_pair

@inline function create_kl_shell_pair(ksh::Int64, lsh::Int64)
  ccall( (:create_kl_shell_pair_c, "/export/home/david/projects/Julia/JuliaChem.jl/src/eri/libjeri.so"),
    Cvoid, (Int64, Int64), ksh, lsh)
end
export create_kl_shell_pair

@inline function fill_kl_shell_pair(ksh::Int64, lsh::Int64)
  ccall( (:fill_kl_shell_pair_c, "/export/home/david/projects/Julia/JuliaChem.jl/src/eri/libjeri.so"),
    Cvoid, (Int64, Int64), ksh, lsh)
end
...
function retrieve_eris(ish::Int64, jsh::Int64, ksh::Int64, lsh::Int64,
  ...
  ccall( (:retrieve_eris_c, "/export/home/david/projects/Julia/JuliaChem.jl/src/eri/libjeri.so"), Cvoid,
